<?php 
/*
Template Name:Faculty List Template
*/
?>
...
<section class="section-background">
     ...
     <div class="section-distance" style="padding-bottom: 60px;">
          <div class="container">
               ...
               <div class="row "> 
                    <?php //get_template_part( "/components/faculty-list", $name = "employee") ?>  
                     <div >
                     <?php query_posts("post_type=mist_employee&filters=permanent&orderby=menu_order&order=DESC&posts_per_page=-1&post_status=publish"); ?>
                     <?php if(have_posts()): ?>
                        <div class="section-title-style"> 
                            <h2 class="">Permanent Faculty Members </h2> 
                        </div>
                    <?php endif; ?>
                ...
                <div class="row "> 
                    ...
                    query_posts('post_type=mist_employee&filters=adjunct&orderby=menu_order&order=DESC&posts_per_page=-1&post_status=publish'); 
                    ?>
                    
                    <?php if(have_posts()): ?>
                    <div class="section-title-style"> 
                        <h2 class=""> Adjunct Faculty Members </h2> 
                    </div>
                    <?php endif; ?>
               ...
               <!--Study Leave -->
                <div class="row "> 
                    ...
                    query_posts('post_type=mist_employee&filters=study-leave&orderby=menu_order&order=DESC&posts_per_page=-1&post_status=publish'); 
                    ?>
                    
                    <?php if(have_posts()): ?>
                    <div class="section-title-style"> 
                        <h2 class="">Study Leave </h2> 
                    </div>
                    <?php endif; ?>
